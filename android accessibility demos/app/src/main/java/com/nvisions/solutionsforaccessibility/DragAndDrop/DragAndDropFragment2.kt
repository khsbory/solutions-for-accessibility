...
import kotlinx.android.synthetic.main.fragment_drag_and_drop2.*

class DragAndDropFragment2 : Fragment() {

    private lateinit var rViewAdapter: DragListAdapter2
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_drag_and_drop2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rViewAdapter = DragListAdapter2(requireContext(), itemArr)
        val callback = DragItemTouchHelperCallback2(rViewAdapter)
        touchHelper = ItemTouchHelper(callback)
        touchHelper.attachToRecyclerView(rView)
        rView.adapter = rViewAdapter
        rViewAdapter.itemDeleteListener = object : DragListAdapter2.OnItemDeleteListener{
        ...
        rViewAdapter.itemMoveListener = object : DragListAdapter2.OnItemMoveListener{
...
class DragItemTouchHelperCallback2(val adapter: DragListAdapter2): ItemTouchHelper.Callback() {
